...
export const media: Record<string, ProjectMedia> = {
  ...
  joyplot: { cover: visual(joy, 'White elevation ridgelines trace Martinique on a lavender background.', 'Martinique'), fit: 'contain', gallery: [visual(joyCzech, 'Overlapping ridge profiles map elevation and population across Czechia.', 'Elevation / Population in Czechia'), visual(joyDominica, 'Ridgeline map of the island of Dominica.', 'Dominica'), visual(joyGrenada, 'Ridgeline map of the island of Grenada.', 'Grenada')] },
